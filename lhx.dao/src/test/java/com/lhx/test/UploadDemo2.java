...
//    String urlbase64 = UrlSafeBase64.encodeToString("目标Bucket_Name:自定义文件key");
    String urlbase64 = UrlSafeBase64.encodeToString("lifeixvideo:1470651456473_9jrdm");
    ...
    public String getUpToken(){
        return auth.uploadToken(bucketname,null,3600,new StringMap()
                .putNotEmpty("persistentOps", pfops), true);
    }
    ...
    public void upload() throws IOException{
        try {
            ...
            Response res = uploadManager.put(FilePath, "1470651456473_9jrdm4.mp4", str);
            //打印返回的信息
            System.out.println(res.bodyString());
        } catch (QiniuException e) {
            Response r = e.response;
