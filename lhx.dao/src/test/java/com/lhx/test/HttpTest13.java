...
public class HttpTest13 {
    ...
    public static String httpPostWithJSON(String url, String userId) throws Exception {
        ...
        jsonArray.put("247624089924010420");
        ...
        jsonParam1.put("msg", "{\"type\"=\"join\",\"userInfo\":{\"name\":\"逗比\"},\"gift\":{\"name\":\"爱心\",\"icon\":\"jfow/dejoeijsdweo.jpg\",\"num\":99}}");
    ...
    public static void main(String[] args) throws Exception {
        ...
        String result = httpPostWithJSON("https://a1.easemob.com/"+ appKey +"/messages", "大大");
